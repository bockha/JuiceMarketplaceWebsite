        ...
        function ($scope, $timeout, c3SimpleService, MyReportsDataService) {
           ...
           $scope.getTopDrinksEver = function () {
            ...
            $scope.getFavoriteJuicesSince = function () {
                MyReportsDataService.getFavoriteJuicesSince().then(function (data) {
            ...
            $scope.getWorkloadSince = function () {
                MyReportsDataService.getWorkloadSince().then(function (data) {
                    ...
                    for (var i = 0; i <= 13; i++) {
                        ...
                        drinks.forEach(function (technologyData) {
            ...
            $scope.getRevenuePerHour = function () {
                MyReportsDataService.getRevenuePerHour().then(function (data) {
            ...
            $scope.getRevenuePerDay = function () {
                MyReportsDataService.getRevenuePerDay().then(function (data) {
